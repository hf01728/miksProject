...
if(empty($diyid))
{
    showMsg('Illegal Operation!', 'javascript:;');
    exit();
}
...
if(preg_match('/,/', $required))
    {
        ...
        foreach($requireds as $field){
            if($$field==''){
                showMsg('With * are required, please fill in correctly', '-1');
                exit();
            }
        }
    }else{
...
$mailtitle = "eb3网站客户留言提交";//邮件标题可自行更改
...
$smtp->debug = false;
$cfg_adminemail2='maxguo@eb3usa.com';
$smtp->sendmail($cfg_adminemail2,$cfg_webname ,$cfg_smtp_usermail, $mailtitle, $mailbody, $mailtype);
